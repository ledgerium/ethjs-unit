...
describe('toWei', () => {
  it('should handle edge cases', () => {
    ...
    assert.equal(units.toWei('.3', 'xlg').toString(10), '300000000000000000');
    assert.throws(() => units.toWei('.', 'wei'), Error);
    assert.throws(() => units.toWei('1.243842387924387924897423897423', 'ether'), Error);
    assert.throws(() => units.toWei('8723.98234.98234', 'xlg'), Error);
  });
  ...
  it('should return the correct value', () => {
    ...
    assert.equal(units.toWei(1, 'xlg').toString(10), '1000000000000000000');
...
describe('fromWei', () => {
  ...
  it('should return the correct value', () => {
    ...
    assert.equal(units.fromWei(1000000000000000000, 'xlg'), '1');
